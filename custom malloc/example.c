...
int main(int argc, char const *argv[])
{
    ...
    */
    ...
    for(int i=0;i<10;i++){
        ...
        printf("Virtual address at i = %d: %lu\n", i, (unsigned long)ptr[i]);
    }
    // printf("printing &ptr[0][1] %d\n", &ptr[0][1]);
    mems_print_stats();
    ...
    */
    ...
    int* phy_ptr2= (int*) mems_get(&ptr[0][1]); // get the address of index 0
    printf("Virtual address: %lu\tPhysical Address: %lu\n",(unsigned long)ptr[0],(unsigned long)phy_ptr2);
    printf("Value written: %d\n", phy_ptr2[0]); // print the address of index 1 
